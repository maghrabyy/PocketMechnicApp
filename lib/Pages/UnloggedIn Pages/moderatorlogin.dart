...
class ModeratorLogin extends StatefulWidget {
  static const String id = 'ModeratorLogin';
  const ModeratorLogin({Key? key}) : super(key: key);

  @override
  State<ModeratorLogin> createState() => _ModeratorLoginState();
}

class _ModeratorLoginState extends State<ModeratorLogin> {
          ...
          boxChild: Column(
            ...
            children: [
              const Padding(
                ...
                child: Text('Login for moderation only.'),
              ),
              Padding(
